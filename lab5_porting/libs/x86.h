...
static inline uint32_t read_ra(void) __attribute__((always_inline));
static inline uint32_t read_fp(void) __attribute__((always_inline));
static inline uint32_t read_sp(void) __attribute__((always_inline));
